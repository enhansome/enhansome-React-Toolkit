...
* **[React Repository](https://github.com/facebook/react) ⭐ 250,560 | 🐛 1,377 | 🌐 JavaScript | 📅 2026-09-18**
...
* **[Wouter](https://github.com/molefrog/wouter) ⭐ 7,895 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-14**: A minimalist-friendly \~2.1KB routing for React and Preact.
...
* **[Virtua](https://github.com/inokawa/virtua) ⭐ 3,747 | 🐛 59 | 🌐 TypeScript | 📅 2026-09-18**: A virtual list and grid library for React.
...
* **[React Player](https://github.com/cookpete/react-player) ⭐ 10,281 | 🐛 62 | 🌐 TypeScript | 📅 2025-11-13**: A React component for playing a variety of URLs, including YouTube, SoundCloud, and more.
...
* **[React Doctor](https://github.com/millionco/react-doctor) ⭐ 14,886 | 🐛 109 | 🌐 TypeScript | 📅 2026-09-18**: AI-powered diagnostic tool that analyzes your React code for performance issues, security problems, and best practices.
...
* **[agent-qa](https://github.com/vostride/agent-qa) ⭐ 881 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03**: Self-improving QA agent for natural-language browser tests with persistent memory and self-healing execution.
...
* **[Winston](https://github.com/winstonjs/winston) ⭐ 24,522 | 🐛 532 | 🌐 JavaScript | 📅 2026-07-20**: A logger for just about everything.
...
* **[OpenAI Node SDK](https://github.com/openai/openai-node) ⭐ 11,180 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-18**: Official OpenAI SDK for TypeScript/JavaScript to integrate GPT models into your React applications.
* **[Anthropic SDK](https://github.com/anthropics/anthropic-sdk-typescript) ⭐ 2,118 | 🐛 75 | 🌐 TypeScript | 📅 2026-09-18**: Official Anthropic TypeScript SDK for integrating Claude AI into your React applications.
...
* **[Changesets](https://github.com/changesets/changesets) ⭐ 12,413 | 🐛 261 | 🌐 TypeScript | 📅 2026-09-16**: A workflow tool for managing versioning and changelogs in monorepos with multiple packages.
...
* **[React](https://github.com/facebook/react) ⭐ 250,560 | 🐛 1,377 | 🌐 JavaScript | 📅 2026-09-18**: The official repository for React, maintained by Facebook.
