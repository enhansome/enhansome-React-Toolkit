...
* **[React Repository](https://github.com/facebook/react) ⭐ 247,206 | 🐛 1,243 | 🌐 JavaScript | 📅 2026-08-13**
...
* **[React Use](https://github.com/streamich/react-use) ⭐ 44,012 | 🐛 664 | 🌐 TypeScript | 📅 2026-06-10**: A library of essential React hooks.
...
* **[Virtua](https://github.com/inokawa/virtua) ⭐ 3,715 | 🐛 69 | 🌐 TypeScript | 📅 2026-08-07**: A virtual list and grid library for React.
...
* **[Next SEO](https://github.com/garmeeh/next-seo) ⭐ 8,507 | 🐛 6 | 🌐 TypeScript | 📅 2026-07-29**: A plugin that makes managing SEO easier in Next.js projects.
...
* **[React Doctor](https://github.com/millionco/react-doctor) ⭐ 14,354 | 🐛 71 | 🌐 TypeScript | 📅 2026-08-13**: AI-powered diagnostic tool that analyzes your React code for performance issues, security problems, and best practices.
...
* **[React Loadable](https://github.com/jamiebuilds/react-loadable) ⭐ 16,513 | 🐛 34 | 🌐 JavaScript | 📅 2024-07-10**: A higher order component for loading components with dynamic imports.
...
* **[clsx](https://github.com/lukeed/clsx) ⭐ 9,832 | 🐛 17 | 🌐 JavaScript | 📅 2024-06-10**: A tiny utility for constructing className strings conditionally in React components.
* **[Axios](https://axios-http.com/)**: A promise-based HTTP client for the browser and Node.js.
...
* **[OpenAI Node SDK](https://github.com/openai/openai-node) ⭐ 11,111 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-12**: Official OpenAI SDK for TypeScript/JavaScript to integrate GPT models into your React applications.
...
* **[Changesets](https://github.com/changesets/changesets) ⭐ 12,263 | 🐛 258 | 🌐 TypeScript | 📅 2026-08-12**: A workflow tool for managing versioning and changelogs in monorepos with multiple packages.
...
* **[React](https://github.com/facebook/react) ⭐ 247,206 | 🐛 1,243 | 🌐 JavaScript | 📅 2026-08-13**: The official repository for React, maintained by Facebook.
