...
# Awesome React Toolkit with stars

Essential libraries and tools for building modern React applications.

[![Stars](https://img.shields.io/github/stars/drbarzaga/react-toolkit?style=flat-square\&color=yellow)](https://github.com/drbarzaga/react-toolkit/stargazers) ⭐ 92 | 🐛 0 | 📅 2026-09-04
[![Forks](https://img.shields.io/github/forks/drbarzaga/react-toolkit?style=flat-square)](https://github.com/drbarzaga/react-toolkit/network/members) ⭐ 92 | 🐛 0 | 📅 2026-09-04
[![Issues](https://img.shields.io/github/issues/drbarzaga/react-toolkit?style=flat-square)](https://github.com/drbarzaga/react-toolkit/issues) ⭐ 92 | 🐛 0 | 📅 2026-09-04
...
* **[React Repository](https://github.com/facebook/react) ⭐ 249,650 | 🐛 1,365 | 🌐 JavaScript | 📅 2026-09-10**
...
* **[Wouter](https://github.com/molefrog/wouter) ⭐ 7,887 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-05**: A minimalist-friendly \~2.1KB routing for React and Preact.
...
* **[SortableJS](https://github.com/SortableJS/react-sortablejs) ⭐ 2,171 | 🐛 109 | 🌐 TypeScript | 📅 2023-12-06**: A React wrapper for SortableJS, a library for reorderable drag-and-drop lists.
* **[React Dragula](https://github.com/bevacqua/react-dragula) ⭐ 995 | 🐛 25 | 🌐 JavaScript | 📅 2020-09-09**: A drag-and-drop library for React based on Dragula.
...
* **[React Use](https://github.com/streamich/react-use) ⭐ 44,011 | 🐛 663 | 🌐 TypeScript | 📅 2026-06-10**: A library of essential React hooks.
...
* **[React Virtualized](https://github.com/bvaughn/react-virtualized) ⭐ 27,075 | 🐛 0 | 🌐 JavaScript | 📅 2025-01-20**: A set of React components for efficiently rendering large lists and tabular data.
* **[Virtua](https://github.com/inokawa/virtua) ⭐ 3,740 | 🐛 62 | 🌐 TypeScript | 📅 2026-09-10**: A virtual list and grid library for React.
...
* **[Google Maps React](https://github.com/google-map-react/google-map-react) ⭐ 6,478 | 🐛 157 | 🌐 JavaScript | 📅 2026-02-17**: A library for embedding Google Maps into React applications.
...
* **[React Player](https://github.com/cookpete/react-player) ⭐ 10,275 | 🐛 62 | 🌐 TypeScript | 📅 2025-11-13**: A React component for playing a variety of URLs, including YouTube, SoundCloud, and more.
* **[React Webcam](https://github.com/mozmorris/react-webcam) ⭐ 1,750 | 🐛 66 | 🌐 TypeScript | 📅 2026-03-10**: A React component for accessing the user's webcam.
...
* **[React Helmet](https://github.com/nfl/react-helmet) ⭐ 17,454 | 🐛 219 | 🌐 JavaScript | 📅 2023-07-18**: A reusable React component that manages changes to the document head.
* **[Next SEO](https://github.com/garmeeh/next-seo) ⭐ 8,514 | 🐛 7 | 🌐 TypeScript | 📅 2026-07-29**: A plugin that makes managing SEO easier in Next.js projects.
...
* **[Validator](https://github.com/validatorjs/validator.js) ⭐ 23,736 | 🐛 501 | 🌐 JavaScript | 📅 2026-08-15**: A library for string validation and sanitization.
...
* **[React Doctor](https://github.com/millionco/react-doctor) ⭐ 14,817 | 🐛 97 | 🌐 TypeScript | 📅 2026-09-10**: AI-powered diagnostic tool that analyzes your React code for performance issues, security problems, and best practices.
...
* **[agent-qa](https://github.com/vostride/agent-qa) ⭐ 909 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03**: Self-improving QA agent for natural-language browser tests with persistent memory and self-healing execution.
...
* **[React Lazy Load](https://github.com/loktar00/react-lazy-load) ⭐ 980 | 🐛 20 | 🌐 TypeScript | 📅 2024-10-14**: A library that helps you defer loading content in your React application until it becomes visible in the viewport.
...
* **[React Loadable](https://github.com/jamiebuilds/react-loadable) ⭐ 16,500 | 🐛 34 | 🌐 JavaScript | 📅 2024-07-10**: A higher order component for loading components with dynamic imports.
...
* **[Winston](https://github.com/winstonjs/winston) ⭐ 24,518 | 🐛 531 | 🌐 JavaScript | 📅 2026-07-20**: A logger for just about everything.
* **[clsx](https://github.com/lukeed/clsx) ⭐ 9,837 | 🐛 16 | 🌐 JavaScript | 📅 2024-06-10**: A tiny utility for constructing className strings conditionally in React components.
* **[Axios](https://axios-http.com/)**: A promise-based HTTP client for the browser and Node.js.
...
* **[OpenAI Node SDK](https://github.com/openai/openai-node) ⭐ 11,169 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-09**: Official OpenAI SDK for TypeScript/JavaScript to integrate GPT models into your React applications.
* **[Anthropic SDK](https://github.com/anthropics/anthropic-sdk-typescript) ⭐ 2,110 | 🐛 60 | 🌐 TypeScript | 📅 2026-09-04**: Official Anthropic TypeScript SDK for integrating Claude AI into your React applications.
...
* **[Changesets](https://github.com/changesets/changesets) ⭐ 12,381 | 🐛 262 | 🌐 TypeScript | 📅 2026-09-10**: A workflow tool for managing versioning and changelogs in monorepos with multiple packages.
...
* **[React](https://github.com/facebook/react) ⭐ 249,650 | 🐛 1,365 | 🌐 JavaScript | 📅 2026-09-10**: The official repository for React, maintained by Facebook.
...
**<dayan.perez9012@gmail.com>** · **[@dayanDev](https://twitter.com/dayanDev)** · **[LinkedIn](https://www.linkedin.com/in/drbarzaga/)**
