...
* **[React Repository](https://github.com/facebook/react) ⭐ 250,668 | 🐛 1,372 | 🌐 JavaScript | 📅 2026-09-22**
...
* **[Wouter](https://github.com/molefrog/wouter) ⭐ 7,897 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-14**: A minimalist-friendly \~2.1KB routing for React and Preact.
...
* **[React Use](https://github.com/streamich/react-use) ⭐ 44,009 | 🐛 665 | 🌐 TypeScript | 📅 2026-06-10**: A library of essential React hooks.
...
* **[React Virtualized](https://github.com/bvaughn/react-virtualized) ⭐ 27,071 | 🐛 0 | 🌐 JavaScript | 📅 2025-01-20**: A set of React components for efficiently rendering large lists and tabular data.
* **[Virtua](https://github.com/inokawa/virtua) ⭐ 3,747 | 🐛 58 | 🌐 TypeScript | 📅 2026-09-23**: A virtual list and grid library for React.
...
* **[Google Maps React](https://github.com/google-map-react/google-map-react) ⭐ 6,480 | 🐛 157 | 🌐 JavaScript | 📅 2026-02-17**: A library for embedding Google Maps into React applications.
...
* **[React Player](https://github.com/cookpete/react-player) ⭐ 10,283 | 🐛 62 | 🌐 TypeScript | 📅 2025-11-13**: A React component for playing a variety of URLs, including YouTube, SoundCloud, and more.
...
* **[React Helmet](https://github.com/nfl/react-helmet) ⭐ 17,453 | 🐛 218 | 🌐 JavaScript | 📅 2023-07-18**: A reusable React component that manages changes to the document head.
* **[Next SEO](https://github.com/garmeeh/next-seo) ⭐ 8,515 | 🐛 8 | 🌐 TypeScript | 📅 2026-07-29**: A plugin that makes managing SEO easier in Next.js projects.
...
* **[Validator](https://github.com/validatorjs/validator.js) ⭐ 23,734 | 🐛 508 | 🌐 JavaScript | 📅 2026-09-11**: A library for string validation and sanitization.
...
* **[React Doctor](https://github.com/millionco/react-doctor) ⭐ 14,913 | 🐛 122 | 🌐 TypeScript | 📅 2026-09-22**: AI-powered diagnostic tool that analyzes your React code for performance issues, security problems, and best practices.
...
* **[agent-qa](https://github.com/vostride/agent-qa) ⭐ 888 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03**: Self-improving QA agent for natural-language browser tests with persistent memory and self-healing execution.
...
* **[React Lazy Load](https://github.com/loktar00/react-lazy-load) ⭐ 982 | 🐛 20 | 🌐 TypeScript | 📅 2024-10-14**: A library that helps you defer loading content in your React application until it becomes visible in the viewport.
...
* **[Winston](https://github.com/winstonjs/winston) ⭐ 24,521 | 🐛 533 | 🌐 JavaScript | 📅 2026-07-20**: A logger for just about everything.
* **[clsx](https://github.com/lukeed/clsx) ⭐ 9,843 | 🐛 16 | 🌐 JavaScript | 📅 2024-06-10**: A tiny utility for constructing className strings conditionally in React components.
* **[Axios](https://axios-http.com/)**: A promise-based HTTP client for the browser and Node.js.
...
* **[React Compare Image](https://github.com/tam315/react-compare-image) ⭐ 407 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-01**: React component to compare two images with a slider
...
* **[OpenAI Node SDK](https://github.com/openai/openai-node) ⭐ 11,186 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-23**: Official OpenAI SDK for TypeScript/JavaScript to integrate GPT models into your React applications.
* **[Anthropic SDK](https://github.com/anthropics/anthropic-sdk-typescript) ⭐ 2,121 | 🐛 80 | 🌐 TypeScript | 📅 2026-09-22**: Official Anthropic TypeScript SDK for integrating Claude AI into your React applications.
...
* **[Changesets](https://github.com/changesets/changesets) ⭐ 12,429 | 🐛 266 | 🌐 TypeScript | 📅 2026-09-22**: A workflow tool for managing versioning and changelogs in monorepos with multiple packages.
...
* **[React](https://github.com/facebook/react) ⭐ 250,668 | 🐛 1,372 | 🌐 JavaScript | 📅 2026-09-22**: The official repository for React, maintained by Facebook.
