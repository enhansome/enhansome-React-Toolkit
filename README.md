...
* **[React Repository](https://github.com/facebook/react) ⭐ 248,662 | 🐛 1,323 | 🌐 JavaScript | 📅 2026-09-02**
...
* **[Wouter](https://github.com/molefrog/wouter) ⭐ 7,872 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-21**: A minimalist-friendly \~2.1KB routing for React and Preact.
...
* **[Virtua](https://github.com/inokawa/virtua) ⭐ 3,732 | 🐛 63 | 🌐 TypeScript | 📅 2026-09-02**: A virtual list and grid library for React.
...
* **[Validator](https://github.com/validatorjs/validator.js) ⭐ 23,737 | 🐛 493 | 🌐 JavaScript | 📅 2026-08-15**: A library for string validation and sanitization.
...
* **[React Doctor](https://github.com/millionco/react-doctor) ⭐ 14,692 | 🐛 84 | 🌐 TypeScript | 📅 2026-09-02**: AI-powered diagnostic tool that analyzes your React code for performance issues, security problems, and best practices.
...
* **[agent-qa](https://github.com/vostride/agent-qa) ⭐ 899 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03**: Self-improving QA agent for natural-language browser tests with persistent memory and self-healing execution.
...
* **[Winston](https://github.com/winstonjs/winston) ⭐ 24,516 | 🐛 531 | 🌐 JavaScript | 📅 2026-07-20**: A logger for just about everything.
...
* **[OpenAI Node SDK](https://github.com/openai/openai-node) ⭐ 11,159 | 🐛 61 | 🌐 TypeScript | 📅 2026-09-02**: Official OpenAI SDK for TypeScript/JavaScript to integrate GPT models into your React applications.
* **[Anthropic SDK](https://github.com/anthropics/anthropic-sdk-typescript) ⭐ 2,104 | 🐛 56 | 🌐 TypeScript | 📅 2026-09-02**: Official Anthropic TypeScript SDK for integrating Claude AI into your React applications.
...
* **[Changesets](https://github.com/changesets/changesets) ⭐ 12,353 | 🐛 260 | 🌐 TypeScript | 📅 2026-08-31**: A workflow tool for managing versioning and changelogs in monorepos with multiple packages.
...
* **[React](https://github.com/facebook/react) ⭐ 248,662 | 🐛 1,323 | 🌐 JavaScript | 📅 2026-09-02**: The official repository for React, maintained by Facebook.
