...
* **[React Repository](https://github.com/facebook/react) ⭐ 248,329 | 🐛 1,333 | 🌐 JavaScript | 📅 2026-08-28**
...
* **[Virtua](https://github.com/inokawa/virtua) ⭐ 3,730 | 🐛 62 | 🌐 TypeScript | 📅 2026-08-30**: A virtual list and grid library for React.
...
* **[React Helmet](https://github.com/nfl/react-helmet) ⭐ 17,458 | 🐛 219 | 🌐 JavaScript | 📅 2023-07-18**: A reusable React component that manages changes to the document head.
...
* **[React Doctor](https://github.com/millionco/react-doctor) ⭐ 14,660 | 🐛 76 | 🌐 TypeScript | 📅 2026-08-30**: AI-powered diagnostic tool that analyzes your React code for performance issues, security problems, and best practices.
...
* **[Winston](https://github.com/winstonjs/winston) ⭐ 24,513 | 🐛 530 | 🌐 JavaScript | 📅 2026-07-20**: A logger for just about everything.
...
* **[OpenAI Node SDK](https://github.com/openai/openai-node) ⭐ 11,151 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-30**: Official OpenAI SDK for TypeScript/JavaScript to integrate GPT models into your React applications.
* **[Anthropic SDK](https://github.com/anthropics/anthropic-sdk-typescript) ⭐ 2,100 | 🐛 56 | 🌐 TypeScript | 📅 2026-08-28**: Official Anthropic TypeScript SDK for integrating Claude AI into your React applications.
...
* **[Changesets](https://github.com/changesets/changesets) ⭐ 12,344 | 🐛 263 | 🌐 TypeScript | 📅 2026-08-30**: A workflow tool for managing versioning and changelogs in monorepos with multiple packages.
...
* **[React](https://github.com/facebook/react) ⭐ 248,329 | 🐛 1,333 | 🌐 JavaScript | 📅 2026-08-28**: The official repository for React, maintained by Facebook.
