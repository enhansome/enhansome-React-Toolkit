...
* **[React Repository](https://github.com/facebook/react) ⭐ 249,141 | 🐛 1,343 | 🌐 JavaScript | 📅 2026-09-04**
...
* **[Wouter](https://github.com/molefrog/wouter) ⭐ 7,876 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-05**: A minimalist-friendly \~2.1KB routing for React and Preact.
...
* **[React Virtualized](https://github.com/bvaughn/react-virtualized) ⭐ 27,077 | 🐛 0 | 🌐 JavaScript | 📅 2025-01-20**: A set of React components for efficiently rendering large lists and tabular data.
* **[Virtua](https://github.com/inokawa/virtua) ⭐ 3,735 | 🐛 60 | 🌐 TypeScript | 📅 2026-09-06**: A virtual list and grid library for React.
...
* **[React Helmet](https://github.com/nfl/react-helmet) ⭐ 17,456 | 🐛 219 | 🌐 JavaScript | 📅 2023-07-18**: A reusable React component that manages changes to the document head.
* **[Next SEO](https://github.com/garmeeh/next-seo) ⭐ 8,509 | 🐛 7 | 🌐 TypeScript | 📅 2026-07-29**: A plugin that makes managing SEO easier in Next.js projects.
...
* **[Validator](https://github.com/validatorjs/validator.js) ⭐ 23,736 | 🐛 494 | 🌐 JavaScript | 📅 2026-08-15**: A library for string validation and sanitization.
...
* **[React Doctor](https://github.com/millionco/react-doctor) ⭐ 14,722 | 🐛 82 | 🌐 TypeScript | 📅 2026-09-06**: AI-powered diagnostic tool that analyzes your React code for performance issues, security problems, and best practices.
...
* **[agent-qa](https://github.com/vostride/agent-qa) ⭐ 901 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03**: Self-improving QA agent for natural-language browser tests with persistent memory and self-healing execution.
...
* **[React Loadable](https://github.com/jamiebuilds/react-loadable) ⭐ 16,504 | 🐛 34 | 🌐 JavaScript | 📅 2024-07-10**: A higher order component for loading components with dynamic imports.
...
* **[Winston](https://github.com/winstonjs/winston) ⭐ 24,519 | 🐛 531 | 🌐 JavaScript | 📅 2026-07-20**: A logger for just about everything.
* **[clsx](https://github.com/lukeed/clsx) ⭐ 9,836 | 🐛 16 | 🌐 JavaScript | 📅 2024-06-10**: A tiny utility for constructing className strings conditionally in React components.
* **[Axios](https://axios-http.com/)**: A promise-based HTTP client for the browser and Node.js.
...
* **[OpenAI Node SDK](https://github.com/openai/openai-node) ⭐ 11,160 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-06**: Official OpenAI SDK for TypeScript/JavaScript to integrate GPT models into your React applications.
* **[Anthropic SDK](https://github.com/anthropics/anthropic-sdk-typescript) ⭐ 2,107 | 🐛 54 | 🌐 TypeScript | 📅 2026-09-04**: Official Anthropic TypeScript SDK for integrating Claude AI into your React applications.
...
* **[Changesets](https://github.com/changesets/changesets) ⭐ 12,374 | 🐛 261 | 🌐 TypeScript | 📅 2026-09-06**: A workflow tool for managing versioning and changelogs in monorepos with multiple packages.
...
* **[React](https://github.com/facebook/react) ⭐ 249,141 | 🐛 1,343 | 🌐 JavaScript | 📅 2026-09-04**: The official repository for React, maintained by Facebook.
