...
* **[React Repository](https://github.com/facebook/react) ⭐ 250,431 | 🐛 1,371 | 🌐 JavaScript | 📅 2026-09-14**
...
* **[Wouter](https://github.com/molefrog/wouter) ⭐ 7,892 | 🐛 24 | 🌐 TypeScript | 📅 2026-09-05**: A minimalist-friendly \~2.1KB routing for React and Preact.
...
* **[Ivy Tendril](https://github.com/Ivy-Interactive/Ivy-Tendril) ⭐ 191 | 🐛 184 | 🌐 C# | 📅 2026-09-14**: Open-source agentic software factory with an amazing UI that handles parallel Git worktrees for you, complete with programmatic verifications and fast review loops.
...
* **[React Use](https://github.com/streamich/react-use) ⭐ 44,009 | 🐛 664 | 🌐 TypeScript | 📅 2026-06-10**: A library of essential React hooks.
...
* **[Virtua](https://github.com/inokawa/virtua) ⭐ 3,744 | 🐛 63 | 🌐 TypeScript | 📅 2026-09-12**: A virtual list and grid library for React.
...
* **[React Webcam](https://github.com/mozmorris/react-webcam) ⭐ 1,750 | 🐛 67 | 🌐 TypeScript | 📅 2026-03-10**: A React component for accessing the user's webcam.
...
* **[Validator](https://github.com/validatorjs/validator.js) ⭐ 23,735 | 🐛 503 | 🌐 JavaScript | 📅 2026-09-11**: A library for string validation and sanitization.
...
* **[React Doctor](https://github.com/millionco/react-doctor) ⭐ 14,842 | 🐛 106 | 🌐 TypeScript | 📅 2026-09-14**: AI-powered diagnostic tool that analyzes your React code for performance issues, security problems, and best practices.
...
* **[Winston](https://github.com/winstonjs/winston) ⭐ 24,520 | 🐛 532 | 🌐 JavaScript | 📅 2026-07-20**: A logger for just about everything.
...
* **[OpenAI Node SDK](https://github.com/openai/openai-node) ⭐ 11,174 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-14**: Official OpenAI SDK for TypeScript/JavaScript to integrate GPT models into your React applications.
* **[Anthropic SDK](https://github.com/anthropics/anthropic-sdk-typescript) ⭐ 2,116 | 🐛 74 | 🌐 TypeScript | 📅 2026-09-10**: Official Anthropic TypeScript SDK for integrating Claude AI into your React applications.
...
* **[Changesets](https://github.com/changesets/changesets) ⭐ 12,390 | 🐛 256 | 🌐 TypeScript | 📅 2026-09-14**: A workflow tool for managing versioning and changelogs in monorepos with multiple packages.
...
* **[React](https://github.com/facebook/react) ⭐ 250,431 | 🐛 1,371 | 🌐 JavaScript | 📅 2026-09-14**: The official repository for React, maintained by Facebook.
