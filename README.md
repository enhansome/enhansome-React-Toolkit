...
* **[React Repository](https://github.com/facebook/react) ⭐ 250,039 | 🐛 1,347 | 🌐 JavaScript | 📅 2026-09-11**
...
* **[React Use](https://github.com/streamich/react-use) ⭐ 44,011 | 🐛 664 | 🌐 TypeScript | 📅 2026-06-10**: A library of essential React hooks.
...
* **[Virtua](https://github.com/inokawa/virtua) ⭐ 3,743 | 🐛 62 | 🌐 TypeScript | 📅 2026-09-11**: A virtual list and grid library for React.
...
* **[React Player](https://github.com/cookpete/react-player) ⭐ 10,277 | 🐛 62 | 🌐 TypeScript | 📅 2025-11-13**: A React component for playing a variety of URLs, including YouTube, SoundCloud, and more.
...
* **[Validator](https://github.com/validatorjs/validator.js) ⭐ 23,736 | 🐛 500 | 🌐 JavaScript | 📅 2026-09-11**: A library for string validation and sanitization.
...
* **[React Doctor](https://github.com/millionco/react-doctor) ⭐ 14,831 | 🐛 99 | 🌐 TypeScript | 📅 2026-09-10**: AI-powered diagnostic tool that analyzes your React code for performance issues, security problems, and best practices.
...
* **[agent-qa](https://github.com/vostride/agent-qa) ⭐ 907 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03**: Self-improving QA agent for natural-language browser tests with persistent memory and self-healing execution.
...
* **[Winston](https://github.com/winstonjs/winston) ⭐ 24,518 | 🐛 532 | 🌐 JavaScript | 📅 2026-07-20**: A logger for just about everything.
...
* **[OpenAI Node SDK](https://github.com/openai/openai-node) ⭐ 11,171 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-11**: Official OpenAI SDK for TypeScript/JavaScript to integrate GPT models into your React applications.
* **[Anthropic SDK](https://github.com/anthropics/anthropic-sdk-typescript) ⭐ 2,113 | 🐛 60 | 🌐 TypeScript | 📅 2026-09-10**: Official Anthropic TypeScript SDK for integrating Claude AI into your React applications.
...
* **[Changesets](https://github.com/changesets/changesets) ⭐ 12,384 | 🐛 263 | 🌐 TypeScript | 📅 2026-09-10**: A workflow tool for managing versioning and changelogs in monorepos with multiple packages.
...
* **[React](https://github.com/facebook/react) ⭐ 250,039 | 🐛 1,347 | 🌐 JavaScript | 📅 2026-09-11**: The official repository for React, maintained by Facebook.
