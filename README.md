...
* **[React Repository](https://github.com/facebook/react) ⭐ 249,631 | 🐛 1,352 | 🌐 JavaScript | 📅 2026-09-07**
...
* **[React Use](https://github.com/streamich/react-use) ⭐ 44,010 | 🐛 663 | 🌐 TypeScript | 📅 2026-06-10**: A library of essential React hooks.
...
* **[Virtua](https://github.com/inokawa/virtua) ⭐ 3,735 | 🐛 63 | 🌐 TypeScript | 📅 2026-09-07**: A virtual list and grid library for React.
...
* **[Validator](https://github.com/validatorjs/validator.js) ⭐ 23,736 | 🐛 499 | 🌐 JavaScript | 📅 2026-08-15**: A library for string validation and sanitization.
...
* **[React Doctor](https://github.com/millionco/react-doctor) ⭐ 14,742 | 🐛 85 | 🌐 TypeScript | 📅 2026-09-07**: AI-powered diagnostic tool that analyzes your React code for performance issues, security problems, and best practices.
...
* **[agent-qa](https://github.com/vostride/agent-qa) ⭐ 902 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03**: Self-improving QA agent for natural-language browser tests with persistent memory and self-healing execution.
...
* **[OpenAI Node SDK](https://github.com/openai/openai-node) ⭐ 11,161 | 🐛 24 | 🌐 TypeScript | 📅 2026-09-07**: Official OpenAI SDK for TypeScript/JavaScript to integrate GPT models into your React applications.
...
* **[Changesets](https://github.com/changesets/changesets) ⭐ 12,376 | 🐛 260 | 🌐 TypeScript | 📅 2026-09-07**: A workflow tool for managing versioning and changelogs in monorepos with multiple packages.
...
* **[React](https://github.com/facebook/react) ⭐ 249,631 | 🐛 1,352 | 🌐 JavaScript | 📅 2026-09-07**: The official repository for React, maintained by Facebook.
