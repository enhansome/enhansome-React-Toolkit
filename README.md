...
* **[React Repository](https://github.com/facebook/react) ⭐ 250,489 | 🐛 1,373 | 🌐 JavaScript | 📅 2026-09-16**
...
* **[Wouter](https://github.com/molefrog/wouter) ⭐ 7,893 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-14**: A minimalist-friendly \~2.1KB routing for React and Preact.
...
* **[React Use](https://github.com/streamich/react-use) ⭐ 44,007 | 🐛 664 | 🌐 TypeScript | 📅 2026-06-10**: A library of essential React hooks.
...
* **[Virtua](https://github.com/inokawa/virtua) ⭐ 3,746 | 🐛 63 | 🌐 TypeScript | 📅 2026-09-16**: A virtual list and grid library for React.
...
* **[Validator](https://github.com/validatorjs/validator.js) ⭐ 23,734 | 🐛 505 | 🌐 JavaScript | 📅 2026-09-11**: A library for string validation and sanitization.
...
* **[React Doctor](https://github.com/millionco/react-doctor) ⭐ 14,859 | 🐛 113 | 🌐 TypeScript | 📅 2026-09-16**: AI-powered diagnostic tool that analyzes your React code for performance issues, security problems, and best practices.
...
* **[agent-qa](https://github.com/vostride/agent-qa) ⭐ 911 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03**: Self-improving QA agent for natural-language browser tests with persistent memory and self-healing execution.
...
* **[React Loadable](https://github.com/jamiebuilds/react-loadable) ⭐ 16,499 | 🐛 34 | 🌐 JavaScript | 📅 2024-07-10**: A higher order component for loading components with dynamic imports.
...
* **[OpenAI Node SDK](https://github.com/openai/openai-node) ⭐ 11,178 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-16**: Official OpenAI SDK for TypeScript/JavaScript to integrate GPT models into your React applications.
* **[Anthropic SDK](https://github.com/anthropics/anthropic-sdk-typescript) ⭐ 2,117 | 🐛 74 | 🌐 TypeScript | 📅 2026-09-15**: Official Anthropic TypeScript SDK for integrating Claude AI into your React applications.
...
* **[Changesets](https://github.com/changesets/changesets) ⭐ 12,397 | 🐛 258 | 🌐 TypeScript | 📅 2026-09-16**: A workflow tool for managing versioning and changelogs in monorepos with multiple packages.
...
* **[React](https://github.com/facebook/react) ⭐ 250,489 | 🐛 1,373 | 🌐 JavaScript | 📅 2026-09-16**: The official repository for React, maintained by Facebook.
