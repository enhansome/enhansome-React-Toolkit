...
* **[React Repository](https://github.com/facebook/react) ⭐ 250,750 | 🐛 1,382 | 🌐 JavaScript | 📅 2026-09-25**
...
* **[Next SEO](https://github.com/garmeeh/next-seo) ⭐ 8,517 | 🐛 8 | 🌐 TypeScript | 📅 2026-07-29**: A plugin that makes managing SEO easier in Next.js projects.
...
* **[React Doctor](https://github.com/millionco/react-doctor) ⭐ 14,925 | 🐛 124 | 🌐 TypeScript | 📅 2026-09-26**: AI-powered diagnostic tool that analyzes your React code for performance issues, security problems, and best practices.
...
* **[OpenAI Node SDK](https://github.com/openai/openai-node) ⭐ 11,187 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-26**: Official OpenAI SDK for TypeScript/JavaScript to integrate GPT models into your React applications.
* **[Anthropic SDK](https://github.com/anthropics/anthropic-sdk-typescript) ⭐ 2,122 | 🐛 81 | 🌐 TypeScript | 📅 2026-09-22**: Official Anthropic TypeScript SDK for integrating Claude AI into your React applications.
...
* **[Changesets](https://github.com/changesets/changesets) ⭐ 12,445 | 🐛 266 | 🌐 TypeScript | 📅 2026-09-22**: A workflow tool for managing versioning and changelogs in monorepos with multiple packages.
...
* **[React](https://github.com/facebook/react) ⭐ 250,750 | 🐛 1,382 | 🌐 JavaScript | 📅 2026-09-25**: The official repository for React, maintained by Facebook.
