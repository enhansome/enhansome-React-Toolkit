...
[![Stars](https://img.shields.io/github/stars/drbarzaga/react-toolkit?style=flat-square\&color=yellow)](https://github.com/drbarzaga/react-toolkit/stargazers) ⭐ 92 | 🐛 0 | 📅 2026-08-12
[![Forks](https://img.shields.io/github/forks/drbarzaga/react-toolkit?style=flat-square)](https://github.com/drbarzaga/react-toolkit/network/members) ⭐ 92 | 🐛 0 | 📅 2026-08-12
[![Issues](https://img.shields.io/github/issues/drbarzaga/react-toolkit?style=flat-square)](https://github.com/drbarzaga/react-toolkit/issues) ⭐ 92 | 🐛 0 | 📅 2026-08-12
...
* **[React Repository](https://github.com/facebook/react) ⭐ 247,220 | 🐛 1,242 | 🌐 JavaScript | 📅 2026-08-13**
...
* **[Wouter](https://github.com/molefrog/wouter) ⭐ 7,865 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-10**: A minimalist-friendly \~2.1KB routing for React and Preact.
...
* **[React Use](https://github.com/streamich/react-use) ⭐ 44,013 | 🐛 664 | 🌐 TypeScript | 📅 2026-06-10**: A library of essential React hooks.
...
* **[React Virtualized](https://github.com/bvaughn/react-virtualized) ⭐ 27,081 | 🐛 1 | 🌐 JavaScript | 📅 2025-01-20**: A set of React components for efficiently rendering large lists and tabular data.
* **[Virtua](https://github.com/inokawa/virtua) ⭐ 3,716 | 🐛 69 | 🌐 TypeScript | 📅 2026-08-07**: A virtual list and grid library for React.
...
* **[React Player](https://github.com/cookpete/react-player) ⭐ 10,280 | 🐛 59 | 🌐 TypeScript | 📅 2025-11-13**: A React component for playing a variety of URLs, including YouTube, SoundCloud, and more.
* **[React Webcam](https://github.com/mozmorris/react-webcam) ⭐ 1,751 | 🐛 65 | 🌐 TypeScript | 📅 2026-03-10**: A React component for accessing the user's webcam.
...
* **[React Helmet](https://github.com/nfl/react-helmet) ⭐ 17,463 | 🐛 220 | 🌐 JavaScript | 📅 2023-07-18**: A reusable React component that manages changes to the document head.
* **[Next SEO](https://github.com/garmeeh/next-seo) ⭐ 8,509 | 🐛 6 | 🌐 TypeScript | 📅 2026-07-29**: A plugin that makes managing SEO easier in Next.js projects.
...
* **[Validator](https://github.com/validatorjs/validator.js) ⭐ 23,741 | 🐛 473 | 🌐 JavaScript | 📅 2026-08-08**: A library for string validation and sanitization.
...
* **[React Doctor](https://github.com/millionco/react-doctor) ⭐ 14,358 | 🐛 70 | 🌐 TypeScript | 📅 2026-08-13**: AI-powered diagnostic tool that analyzes your React code for performance issues, security problems, and best practices.
...
* **[React Lazy Load](https://github.com/loktar00/react-lazy-load) ⭐ 981 | 🐛 20 | 🌐 TypeScript | 📅 2024-10-14**: A library that helps you defer loading content in your React application until it becomes visible in the viewport.
...
* **[React Loadable](https://github.com/jamiebuilds/react-loadable) ⭐ 16,511 | 🐛 34 | 🌐 JavaScript | 📅 2024-07-10**: A higher order component for loading components with dynamic imports.
...
* **[Winston](https://github.com/winstonjs/winston) ⭐ 24,506 | 🐛 528 | 🌐 JavaScript | 📅 2026-07-20**: A logger for just about everything.
* **[clsx](https://github.com/lukeed/clsx) ⭐ 9,833 | 🐛 17 | 🌐 JavaScript | 📅 2024-06-10**: A tiny utility for constructing className strings conditionally in React components.
* **[Axios](https://axios-http.com/)**: A promise-based HTTP client for the browser and Node.js.
...
* **[React Compare Image](https://github.com/tam315/react-compare-image) ⭐ 406 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-07**: React component to compare two images with a slider
...
* **[OpenAI Node SDK](https://github.com/openai/openai-node) ⭐ 11,112 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-12**: Official OpenAI SDK for TypeScript/JavaScript to integrate GPT models into your React applications.
* **[Anthropic SDK](https://github.com/anthropics/anthropic-sdk-typescript) ⭐ 2,078 | 🐛 49 | 🌐 TypeScript | 📅 2026-08-12**: Official Anthropic TypeScript SDK for integrating Claude AI into your React applications.
...
* **[Changesets](https://github.com/changesets/changesets) ⭐ 12,266 | 🐛 260 | 🌐 TypeScript | 📅 2026-08-12**: A workflow tool for managing versioning and changelogs in monorepos with multiple packages.
...
* **[React](https://github.com/facebook/react) ⭐ 247,220 | 🐛 1,242 | 🌐 JavaScript | 📅 2026-08-13**: The official repository for React, maintained by Facebook.
