...
* **[React Repository](https://github.com/facebook/react) ⭐ 250,538 | 🐛 1,375 | 🌐 JavaScript | 📅 2026-09-17**
...
* **[Virtua](https://github.com/inokawa/virtua) ⭐ 3,746 | 🐛 59 | 🌐 TypeScript | 📅 2026-09-17**: A virtual list and grid library for React.
...
* **[React Doctor](https://github.com/millionco/react-doctor) ⭐ 14,869 | 🐛 113 | 🌐 TypeScript | 📅 2026-09-16**: AI-powered diagnostic tool that analyzes your React code for performance issues, security problems, and best practices.
...
* **[agent-qa](https://github.com/vostride/agent-qa) ⭐ 912 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03**: Self-improving QA agent for natural-language browser tests with persistent memory and self-healing execution.
...
* **[clsx](https://github.com/lukeed/clsx) ⭐ 9,840 | 🐛 16 | 🌐 JavaScript | 📅 2024-06-10**: A tiny utility for constructing className strings conditionally in React components.
* **[Axios](https://axios-http.com/)**: A promise-based HTTP client for the browser and Node.js.
...
* **[OpenAI Node SDK](https://github.com/openai/openai-node) ⭐ 11,178 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-17**: Official OpenAI SDK for TypeScript/JavaScript to integrate GPT models into your React applications.
* **[Anthropic SDK](https://github.com/anthropics/anthropic-sdk-typescript) ⭐ 2,117 | 🐛 73 | 🌐 TypeScript | 📅 2026-09-15**: Official Anthropic TypeScript SDK for integrating Claude AI into your React applications.
...
* **[Changesets](https://github.com/changesets/changesets) ⭐ 12,405 | 🐛 259 | 🌐 TypeScript | 📅 2026-09-16**: A workflow tool for managing versioning and changelogs in monorepos with multiple packages.
...
* **[React](https://github.com/facebook/react) ⭐ 250,538 | 🐛 1,375 | 🌐 JavaScript | 📅 2026-09-17**: The official repository for React, maintained by Facebook.
